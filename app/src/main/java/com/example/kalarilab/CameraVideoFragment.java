...
public abstract class CameraVideoFragment extends android.app.Fragment {
    ...
    private com.example.imageclassificationlivefeed.AutoFitTextureView mTextureView;
    /**
    ...
    private static Size chooseOptimalSize(Size[] choices, int width, int height, Size aspectRatio) {
        ...
        if (bigEnough.size() > 0) {
            return Collections.min(bigEnough, new CameraConnectionFragment.CompareSizesByArea());
        } else {
    ...
    public void startRecordingVideo() throws CameraAccessException, IOException {
        if (null == mCameraDevice || !mTextureView.isAvailable() || null == mPreviewSize) {
            return;
        }
        try {
