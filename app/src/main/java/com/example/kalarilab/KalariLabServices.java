...
public class KalariLabServices {
    private final static String BASE_URL = "http://192.168.0.122:8000/";
    ...
    public void updateInfo(VolleyCallbacks volleyCallbacks,String gender, String birthDay, String bio){
        ...
        addPutRequestParams(gender, birthDay, bio, sessionManagement.returnUser_Membership());
    ...
    private void addPutRequestParams(String gender, String birthDay, String bio, String membership) {
        ...
        putRequestParams.put("membership", membership);
    ...
    public void updateMembership(VolleyCallbacks volleyCallbacks, String membership){
        sessionManagement = new SessionManagement(context);

        addPutRequestParams(sessionManagement.returnUser_Gender(), sessionManagement.returnUser_birthDate(),
                sessionManagement.returnUser_Bio(), membership);
        JSONObject jsonObj = new JSONObject(putRequestParams);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.PUT,url,jsonObj,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            Log.d("SessionDebug", response.toString());
                            volleyCallbacks.onSuccess_PremiumActivity(response);
